  ...
  try {
    ...
    for (const clip of clips) {
      ...
      const narration = {
        ...
        narration:
          "Dive deep into the tranquil waters where time slows and the world above fades away. Feel the gentle rhythm of your breath as you explore the underwater realm, surrounded by vibrant coral and curious marine life.",
        caption:
